# MiniFASNet model definitions for face anti-spoofing / presentation-attack detection (PAD).
#
# Vendored (verbatim architecture) from the open-source Silent-Face-Anti-Spoofing project
# by Minivision AI (https://github.com/minivision-ai/Silent-Face-Anti-Spoofing, Apache-2.0).
# Kept inside the project so CodeWatch has no runtime dependency on that repo.
import torch
