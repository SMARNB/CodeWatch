...
export const fetchStatistics = async () => {
  try {
    ...
    return {
      nonViolators: { title: 'Non-Violators', value: stats.nonViolators.value, percentageChange: '', miniChartData: [] },
      unauthorized: { title: 'Total Violations', value: stats.unauthorized.value, percentageChange: '', miniChartData: [] },
      violators: { title: 'Active Violators', value: stats.violators.value, percentageChange: '', miniChartData: [] },
      victors: { title: 'Total Tracked', value: stats.victors.value, percentageChange: '', miniChartData: [] },
    };
  } catch (error) {
