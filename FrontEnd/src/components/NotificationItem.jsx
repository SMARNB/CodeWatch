    ...
    >
      ...
      <div className="flex-1 min-w-0 flex items-center justify-between">
        <div className="flex-1 min-w-0">
          <div className="flex items-center" style={{ marginTop: '5px', marginBottom: '10px' }}>
            {/* Icon */}
            {iconElement && (
              <div 
                className={`mr-3 flex-shrink-0 ${statusStyles.iconColor}`}
            ...
            {/* Message */}
            <div
              className={`font-medium text-sm flex-1 ${statusStyles.textColor}`}
          ...
          {/* Details */}
          {details && (
            <div className="text-xs text-gray-600 mb-1" style={{ paddingLeft: '20px', paddingRight: '20px' }}>
              {details}
            </div>
          )}
        </div>
        ...
        {/* Timestamp */}
        {timestamp && (
          <div className="text-xs text-gray-500 whitespace-nowrap ml-4 flex-shrink-0" style={{ paddingRight: '20px' }}>
