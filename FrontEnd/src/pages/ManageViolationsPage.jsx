...
const ManageViolationsPage = () => {
  ...
  const handleViolationClick = (violation) => {
    if (violation.notification_id) {
      ...
      setAlertData({ isOpen: true, message: "No linked notification for this violation." });
    }
  };
    ...
    setConfirmState({
      ...
      onConfirm: async () => {
        try {
          ...
          setAlertData({ isOpen: true, message: "Failed to delete some violations." });
        }
      }
    });
  };
                                  ...
                                  setConfirmState({
                                    ...
                                    onConfirm: async () => {
                                      try {
                                        ...
                                        setAlertData({ isOpen: true, message: "Record Deleted" });
                                      } catch (err) {
                                        console.error("Failed to delete:", err);
                                        setAlertData({ isOpen: true, message: "Failed to delete violation." });
                                      }
                                    }
                                  });
                                }}
